<template>
  <div>
    <div>
      ...
      <el-input v-model="value" placeholder="请输入您想搜索的商品名称" class="forms"></el-input>
    </div>
    <div class="m-t-30">
      <el-table
      ...
      >
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button size="mini" @click="clickItem(scope.$index, scope.row)" class="release">
      ...
      <el-dialog title :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
        <el-form>
          <el-form-item label="名称">
            <el-input v-model="ass.NAME" class="eipt"></el-input>
          </el-form-item>
          <el-form-item label="原价">
            <el-input v-model="ass.ORI_PRICE" class="eipt"></el-input>
          </el-form-item>
          <el-form-item label="现价">
            <el-input v-model="ass.PRESENT_PRICE" class="eipt"></el-input>
          </el-form-item>
        </el-form>
