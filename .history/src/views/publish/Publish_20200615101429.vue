  ...
  <div class="push">
    ...
    <div class="d-f">
      <el-form ref="ruleForm" label-width="100px" class="demo-ruleForm  d-f publish2">
        ...
        <el-form-item label="类目" prop=" category" :rules="[{ required: true, trigger: 'blur' }]" class="item2">
          ...
          <el-form-item label="来源" prop="source" :rules="[{ required: true, trigger: 'blur' }]" class="item2">
   ...
   <el-form-item label="重要性" prop="star" :rules="[{ required: true, trigger: 'blur' }]" class="item2">
...
export default {
  ...
  methods: {
    pub(){
      axios.post("/api/article/create").then(res=>{
