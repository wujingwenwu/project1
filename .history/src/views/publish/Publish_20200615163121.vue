<template>
  <div class="push">
    ...
    <div class="d-f">
      ...
      >
        ...
        >
          <el-select v-model="ruleForm.category" placeholder="请选择">
            <el-option type="success" label="vue" value="Vue"></el-option>
            <el-option type="info"  label="React" value="React"></el-option>
            <el-option type="danger"  label="Nodejs" value="Nodejs"></el-option>
            <el-option   type="success" label="性能优化" value="性能优化"></el-option>
            <el-option type="warning" label="JavaScript" value="JavaScript"></el-option>
            <el-option   type="warning" label="小程序" value="小程序"></el-option>
            <el-option   type="danger" label="工具类" value="工具类"></el-option>
      ...
      <el-tag type="danger"  v-if="scope.row.category==='Node.js'">{{scope.row.category}}</el-tag>
