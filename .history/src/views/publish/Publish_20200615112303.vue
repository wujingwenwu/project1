  ...
  <div class="push">
    ...
    <div class="m-t-30">
      ...
      <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="文章标题" prop="title" :rules="[{ required: true, message: '请输入标题', trigger: 'blur' }]">
          <el-input v-model="ruleForm.title"></el-input>
        </el-form-item>
        <el-form-item  label="文章摘要" prop="abstract" :rules="[{ required: true, message: '请输入摘要', trigger: 'blur' }]">
      ...
      >
        ...
        >
          <el-select v-model="ruleForm.star" placeholder="请选择">
            <el-option label="1" value="shanghait"></el-option>
            <el-option label="2" value="beijingq"></el-option>
            <el-option label="3" value="beijingw"></el-option>
            <el-option label="4" value="beijinge"></el-option>
            <el-option label="5" value="beijingr"></el-option>
          </el-select>
        </el-form-item>
