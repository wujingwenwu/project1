<template>
  <div class="push">
    <div class="publish">
      <div class="d-f publish1">
        ...
        <el-button type="primary" @click="clcikItem">发布</el-button>
      </div>
    </div>
    <div class="m-t-30">
    ...
    <div class="d-f">
      <el-form ref="ruleForm" label-width="100px" class="demo-ruleForm  d-f publish2">
        ...
        <el-form-item label="类目" prop="region" :rules="[{ required: true, trigger: 'blur' }]">
          ...
          <el-form-item label="来源" prop="region" :rules="[{ required: true, trigger: 'blur' }]">
    <el-select v-model="ruleForm.region" placeholder="请选择">
   ...
   <el-form-item label="重要性" prop="region" :rules="[{ required: true, trigger: 'blur' }]">
    <el-select v-model="ruleForm.region" placeholder="请选择">
   ...
   <el-form-item label="发布时间" required>
    ...
    <el-col :span="11">
      <el-form-item prop="date2">
        <el-time-picker placeholder="选择日期时间" v-model="ruleForm.date2" style="width: 150px;"></el-time-picker>
      </el-form-item>
    </el-col>
  </el-form-item>
      </el-form>
 ...
 <div v-html="htmlValue"></div>
  <el-button type="primary" @click="clcikItem" class="publish3">发布</el-button>
  </div>
</template>
