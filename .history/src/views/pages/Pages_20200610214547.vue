<template>
  <div>
    <el-container>
      <el-header class="d-f a-i-c">
        <div class="d-f a-i-c pages2 j-c-s-b">
          <div class="f-c-b pages1">欢迎{{obj.username}}来到小爱后台管理系统</div>
          <div class="d-f pages1">
...
export default {
  ...
  mounted() {
    ...
    let items = dayjs(this.obj.time).format("HH");
    if (items > 5 && items <= 11) {
      this.items = "早上好";
